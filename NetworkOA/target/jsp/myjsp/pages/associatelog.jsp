                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<%=basePath%>log/associate/get.do?page=1" class="active">交接日志</a>
                            </li>
                            <li>
                                <a href="#">签到表</a>
                            </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="text-right" style="padding-top: 10px;" >
                    <button type="button" class="btn btn-info">显示全部</button>
                    <button type="button" class="btn btn-info">显示未完成的</button>
                    <div>
                <!--分页-->
            </div>
        </div>
