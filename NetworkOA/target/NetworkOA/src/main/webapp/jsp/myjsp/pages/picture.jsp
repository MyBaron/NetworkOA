             ...
             <div class="col-lg-12">
               <!--  <div id="fh5co-page">
                 ...
                 <div id="masonry" class="container-fluid">
                     <div class="box"><a href="<%=basePath%>jsp/myjsp/mypicture/images/work_1.jpg" data-lightbox="image-1" data-title="文字说明"><img src="<%=basePath%>jsp/myjsp/mypicture/images/work_1.jpg" />vvv</a></div>
                     <div class="box"><a href="<%=basePath%>jsp/myjsp/mypicture/images/work_2.jpg" data-lightbox="image-1" data-title="文字说明"><img src="<%=basePath%>jsp/myjsp/mypicture/images/work_2.jpg" />vvv</a></div>
