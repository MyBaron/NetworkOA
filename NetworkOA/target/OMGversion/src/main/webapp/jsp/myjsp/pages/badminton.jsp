                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<%=basePath%>venue/get/badminton.do" class="action">羽毛球场</a>
                            </li>
                            <li>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form method="post" action="<%=basePath%>venue/put/badminton.do?venue_id=3">
                                   ...
                                   <tr>
                                       ...
                                       <td>
                                           <div style="padding-left: 0" >
                                               <img src="<%=basePath%>jsp/myjsp/picture/badminton.png" class="img-responsive">
                                           </div>
                                       </td>
                                   </tr>
                                   <tr>
