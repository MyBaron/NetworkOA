...
<head>
   ...
   <link href="<%=basePath%>jsp/myjsp/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<%=basePath%>jsp/myjsp/jPages-master/css/jPages.css">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <!--订单管理-->
                    <li>
                        <a href="<%=basePath%>gym/getmessage.do" class="active"><i class="fa fa-table fa-fw"></i> 订单管理</a>
                    </li>
                    <!--订单管理-->
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <c:forEach var="tr" items="${gym}">
                               <tr>
                                   ...
                                   <td><c:out value="${tr.gym_time}"></c:out></td>
                                   ...
                                   <td><button type="button" class="btn btn-info" onclick="get('<%=basePath%>gym/get.do?',${tr.gym_id},${tr.user_id})">详情 </button></td>
                               </tr>
                           </c:forEach>
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody >
                              ...
                              <tr>
                                  <td>预订时间</td>
                                  <td>${gymlist.gym_begin_time}</td>
                              </tr>
                              <tr>
                                  <td>时长</td>
                                  <td>${gymlist.gym_long_time}</td>
                              </tr>
                              <tr>
                                  <td>订单价格</td>
                                  <td>${gymlist.gym_money}</td>
                              </tr>
                              <tr>
                                  <td>用户名字</td>
                              ...
                              <tr>
                                  <td>用户经验</td>
                                  <td>${user.user_experi}</td>
                              </tr>
                              <tr>
                                  <td>支付时间</td>
                                  <td>${gymlist.gym_time}</td>
                              </tr>
                            </tbody>
...
<script src="<%=basePath%>jsp/myjsp/js/order.js"></script>
