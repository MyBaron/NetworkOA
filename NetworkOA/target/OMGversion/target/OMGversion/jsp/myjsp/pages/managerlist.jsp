        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <!--管理员管理-->
                    <li>
                    <a href="<%=basePath%>manager/get.do" class="active"><i class="glyphicon glyphicon-user"></i> 管理员管理</a>
                    </li>
                    <!--管理员管理-->
                </ul>
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <c:forEach var="tr" items="${manager}">
                               <tr>
                                   <td><c:out value="${tr.manager_id}"></c:out></td>
                                   <td ><c:out value="${tr.manager_name}"></c:out></td>
                                   <td><c:out value="${tr.manager_account}"></c:out></td>
                                   <td><c:out value="${tr.manager_right}"></c:out></td>
