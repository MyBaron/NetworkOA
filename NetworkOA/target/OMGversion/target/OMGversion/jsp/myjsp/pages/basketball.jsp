                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<%=basePath%>venue/get/basketball.do" class="active">篮球场</a>
                            </li>
                            <li>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form method="post" action="<%=basePath%>venue/put/basketball.do?venue_id=1" >
                               ...
                               <tbody>
                                   <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-lg-2" style="padding-left: 0" >
                                                <input type="text" class="form-control" name="venue_begin"  value="${venue_begin}" placeholder="${venue_begin}" onkeyup="(this.v=function(){this.value=this.value.replace(/[0-9-()（）]{15,20}/,'');}).call(this)" onblur="this.v();">
                                            </div>
                                        </td>
                                    </tr>
                                   <tr>
                                   ...
                                   <tr>
                                       ...
                                       <td>
                                           <div class="col-lg-4" style="padding-left: 0" >
                                               <input type="text" class="form-control" name="venue_phone" value="${venue_phone}" placeholder="${venue_phone}">
                                           </div>
                                       </td>
                                   </tr>
                                   <tr>
                                   ...
                                   <tr>
                                       ...
                                       <td>
                                           <div style="padding-left: 0" >
                                               <img src="<%=basePath%>jsp/myjsp/picture/basketball1.png" class="img-responsive">
                                           </div>
                                       </td>
                                   </tr>
                                   <tr>
