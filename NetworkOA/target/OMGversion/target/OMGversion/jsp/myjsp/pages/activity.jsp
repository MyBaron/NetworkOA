        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <!--活动管理-->
                    <li>
                        <a href="<%=basePath%>activity/get.do" class="active"><i class="fa fa-edit fa-fw"></i> 活动管理</a>
                    </li>
                    <!--活动管理-->
                    <!--会员管理-->
                    <li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" >
                          ...
                          <c:forEach var="tr" items="${activity}">
                               <tr>
                                   <td><c:out value="${tr.activity_id}"></c:out></td>
                                   <td><c:out value="${tr.activity_text}"></c:out></td>
                                   <td><c:out value="${tr.activity_time}"></c:out></td>
                                   <td>
                                       <button type="button" class="btn btn-info">修改 </button>
                                       <button type="button" class="btn btn-info" id="mydelete" onclick="mydelete(${tr.activity_id},'<%=basePath%>activity/delete.do?activity_id=')">删除 </button>
                                   </td>
                               </tr>
                           </c:forEach>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<%=basePath%>activity/put.do">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <textarea class="form-control" name="activity_text" placeholder="活动内容"  rows="3" required="required"></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
...
<script src="<%=basePath%>jsp/myjsp/js/activity.js"></script>
