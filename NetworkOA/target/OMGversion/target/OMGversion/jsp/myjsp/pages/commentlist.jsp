        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <!--评论管理-->
                    <li>
                        <a href="<%=basePath%>comment/get.do" class="active"><i class="fa fa-wrench fa-fw"></i> 评论管理</a>
                    </li>
                    <!--评论管理-->
                    <!--管理员管理-->
                    <li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <c:forEach var="tr" items="${comment}">
                               <tr>
                                   <td><c:out value="${tr.comment_id}"></c:out></td>
                                   <td ><c:out value="${tr.venue_name}"></c:out></td>
                                   <td><c:out value="${tr.comment_text}"></c:out></td>
                                   <td><c:out value="${tr.user_name}"></c:out></td>
                                   <td><c:out value="${tr.comment_time}"></c:out></td>
